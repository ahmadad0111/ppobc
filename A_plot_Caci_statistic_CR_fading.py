...
for index_run in range(0,num_run_index):
    ireca_return_softmax_env_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_softmax_env_{index_run}.npy'))
...
plt.xlim([0, 150])
plt.ylim([-0.1, 2])
plt.savefig('./figs/cr_fading_compare_softmax_env_return.pdf', format='pdf')

# print('\n---------------------------------------- fading weights solo ----------------------------------------\n')
ireca_return_softmax_ent_all= []

for index_run in range(0,num_run_index):
    ireca_return_softmax_ent_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_softmax_ent_{index_run}.npy'))
...
plt.xlim([0, 150])
plt.ylim([-0.1, 2])
plt.savefig('./figs/cr_fading_compare_softmax_ent_return.pdf', format='pdf')
...
for index_run in range(0,num_run_index):
    ireca_return_softmax_cau_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_softmax_cau_{index_run}.npy'))
...
plt.xlim([0, 150])
plt.ylim([-0.1, 2])
plt.savefig('./figs/cr_fading_compare_softmax_cau_return.pdf', format='pdf')
...
for index_run in range(0,num_run_index):
    ppobc_return_shaped_all.append(np.load(f'./data/cr_ppobc/rc_data_fading_ppobc_return_shaped_{index_run}.npy'))
    ppobc_return_sparse_all.append(np.load(f'./data/cr_ppobc/rc_data_fading_ppobc_return_sparse_{index_run}.npy'))
    ppobc_return_env_all.append(np.load(f'./data/cr_ppobc/rc_data_fading_ppobc_return_env_{index_run}.npy'))
...
plt.xlim([0, xlim_max])
plt.ylim([0, ylim_max])
plt.savefig('./figs/cr_fading_return_ppobc.pdf', format='pdf')
...
for index_run in range(0,num_run_index):
    ireca_return_shaped_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_return_shaped_{index_run}.npy'))
    ireca_return_sparse_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_return_sparse_{index_run}.npy'))
    ireca_return_env_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_return_cau_{index_run}.npy'))
    ireca_return_cau_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_return_cau_{index_run}.npy'))
    ireca_return_ent_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_return_ent_{index_run}.npy'))
    ireca_return_ireca_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_return_ireca_{index_run}.npy'))
...
print(np.shape(ireca_return_shaped_all))
...
plt.xlim([0, xlim_max])
plt.ylim([0, ylim_max])
plt.savefig('./figs/cr_fading_return_ireca.pdf', format='pdf')
...
for index_run in range(0,num_run_index):
    causal_return_shaped_all.append(np.load(f'./data/cr_causal/rc_data_fading_causal_return_shaped_{index_run}.npy'))
    causal_return_sparse_all.append(np.load(f'./data/cr_causal/rc_data_fading_causal_return_sparse_{index_run}.npy'))
    causal_return_env_all.append(np.load(f'./data/cr_causal/rc_data_fading_causal_return_env_{index_run}.npy'))
    causal_return_cau_all.append(np.load(f'./data/cr_causal/rc_data_fading_causal_return_cau_{index_run}.npy'))
    causal_return_causal_all.append(np.load(f'./data/cr_causal/rc_data_fading_causal_return_causal_{index_run}.npy'))
...
plt.xlim([0, xlim_max])
plt.ylim([0, ylim_max])
plt.savefig('./figs/cr_fading_return_causal.pdf', format='pdf')
...
# func_plot_shaded(ireca_return_cau_all,    label= 'IReCa',   color='C6')
# plt.xlabel('Epoch', fontsize = 12)
...
# plt.xlim([0, xlim_max])
# plt.ylim([0, 150])
# plt.savefig('./figs/cr_fading_return_cau.pdf', format='pdf')
...
plt.xlim([0, xlim_max])
plt.ylim([0, ylim_max])
plt.savefig('./figs/cr_fading_compare_sparse_return.pdf', format='pdf')
...
plt.xlim([0, xlim_max])
plt.ylim([0, ylim_max])
plt.savefig('./figs/cr_fading_compare_shaped_return.pdf', format='pdf')
...
#     ppobc_return_env_all.append(np.load(f'./data/cr_ppobc/rc_data_fading_ppobc_return_env_{index_run}.npy'))
#     causal_return_env_all.append(np.load(f'./data/cr_causal/rc_data_fading_causal_return_env_{index_run}.npy'))
#     ireca_return_env_all.append(np.load(f'./data/cr_ireca/rc_data_fading_ireca_return_env_{index_run}.npy'))
...
# plt.savefig('./figs/cr_fading_compare_env_return.pdf', format='pdf')

# print('\n---------------------------------------- (testing cr)----------------------------------------\n')

# 读取数据
cr_ppobc_return_sparse_mean = np.mean(np.load(f'./data/test/cr_ppobc/rc_test_data_fading_ppobc_return_sparse_0.npy'))
cr_causal_return_sparse_mean = np.mean(np.load(f'./data/test/cr_causal/rc_test_data_fading_causal_return_sparse_0.npy'))
cr_ireca_return_sparse_mean = np.mean(np.load(f'./data/test/cr_ireca/rc_test_data_fading_ireca_return_sparse_0.npy'))

# 设置任务和模型
tasks = ["Sparse return"]
models = ["PPO$_{\mathrm{BC}}$", "Causal", "IReCa"]
data = [cr_ppobc_return_sparse_mean, cr_causal_return_sparse_mean, cr_ireca_return_sparse_mean]
...
# print('\n---------------------------------------- (testing cr stage)----------------------------------------\n')
cr_ppobc_return_sparse_mean = np.mean(np.load(f'./data/test/cr_ppobc/rc_test_data_fading_ppobc_return_shaped_0.npy'))
cr_causal_return_sparse_mean = np.mean(np.load(f'./data/test/cr_causal/rc_test_data_fading_causal_return_shaped_0.npy'))
cr_ireca_return_sparse_mean = np.mean(np.load(f'./data/test/cr_ireca/rc_test_data_fading_ireca_return_shaped_0.npy'))
...
# ax.legend(loc='upper right', fontsize=12, ncol=1)
# 保存图形
plt.savefig('./figs/test_cr_shaped_fading_compare_return.pdf', format='pdf')
