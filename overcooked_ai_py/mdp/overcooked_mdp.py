...
class OvercookedGridworld(object):
    ...
    def __init__(
        ...
        order_bonus=2,
        start_state=None,
        old_dynamics=False, # was initialized as False
        **kwargs
    ):
        """
    ...
    def resolve_interacts(self, new_state, joint_action, events_infos):
        ...
        for player_idx, (player, action) in enumerate(zip(new_state.players, joint_action)): # enumerate 会创建一个枚举器，这个枚举器，每次迭代的时候给一个元组 (player_idx, (player, action))
